...
RELEASES_URL = 'https://api.github.com/repos/atticus-lv/ad_jewel_tools/releases?per_page=10'
...
class ADJT_check_update(bpy.types.Operator):
    bl_idname = 'ajdt.check_update'
...
def register():
    bpy.utils.register_class(ADJT_check_update)


def unregister():
    bpy.utils.unregister_class(ADJT_check_update)
