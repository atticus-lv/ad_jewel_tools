...
class ADJT_OT_Curve(ADJT_OT_ModalTemplate):
    '''apply Preset
应用预设'''
    ...
    def poll(self, context):
        if context.active_object:
            return len(context.selected_objects) == 1 and context.active_object.type == 'CURVE'

    def main(self, context):
        self.display_ob = context.active_object
        mod = self.display_ob.modifiers.new(name='ADJT_Curve_modifier', type='NODES')
